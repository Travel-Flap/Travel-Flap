// import "../Favourite_hotels/Favourite_hotels.css"
// import { BsFillChatLeftFill, BsFillStarFill, BsStarHalf } from "react-icons/bs";
// export function Favourite_Hotels() {

//     return (
//         <>
//             <h4 className="Favouite_hotels">Favourite hotels around the globe</h4>
...
//                             <span className="discount_percent">41% DISCOUNT</span>
//                             <span className="Price_before_discount">&#x24;19,662</span>
//                             <span className="Price_after_discount">&#x24;11,611</span>
//                         </div>
//                     </div>
//                     <div className=" trip_card_div">
//                         <div className="reviwe">
...
//                         </div>
//                         <div className="discount_price">
//                             <span className="discount_percent">85% DISCOUNT</span>
//                             <span className="Price_before_discount">&#x24;15,528</span>
//                             <span className="Price_after_discount">&#x24;7,832</span>
//                         </div>
//                     </div>
//                     <div className=" trip_card_div">
//                         <div className="reviwe">
...
//                         </div>
//                         <div className="discount_price">
//                             <span className="discount_percent">63% DISCOUNT</span>
//                             <span className="Price_before_discount">&#x24;26,063</span>
//                             <span className="Price_after_discount">&#x24;9,562</span>
//                         </div>
//                     </div>
//                     <div className=" trip_card_div">
//                         <div className="reviwe">
...
//                         </div>
//                         <div className="discount_price">
//                             <span className="discount_percent">76% DISCOUNT</span>
//                             <span className="Price_before_discount">&#x24;93,747</span>
//                             <span className="Price_after_discount">&#x24;22,841</span>
//                         </div>
//                     </div>
